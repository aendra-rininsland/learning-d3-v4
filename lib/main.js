...
// westerosChart.init('histogram', 'data/GoT-character-deaths.csv');
// westerosChart.init('chord', 'data/stormofswords.csv');
// westerosChart.init('force', 'data/stormofswords.csv');
// westerosChart.init('stream', 'data/GoT-deaths-by-season.json');
// westerosChart.init('stack', 'data/GoT-lines-per-episode-by-season.json');
